   ...
   <div style="height:100%;width:100%" class="panel panel-default" >
     ...
     <tr  style="height:100%;margin:10%">
         ...
         <td><asp:TextBox runat="server" class="col-xs-3" ID="txtMatchName" CssClass="form-control" DataSourceID="SqlDataSource1" DataTextField="MatchName" DataValueField="MatchName"></asp:TextBox>
           <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtMatchName" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtMatchName" ValidationExpression="^[A-Z]{1}[a-z\s]{1,}$" Text=" Start with capital" ErrorMessage="[Start with capital]" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                </td>
         </td>
     </tr>
    ...
    <tr style="margin:10%">
        ...
        <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtScheduleDate" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
     <tr style="margin:10%">
     ...
     <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtStartTime" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
     <tr style="margin:10%">
         ...
         <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtEndTime" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
     <tr><td><br /></td></tr>
     <tr>
