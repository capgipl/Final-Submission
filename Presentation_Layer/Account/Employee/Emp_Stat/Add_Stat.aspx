...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div style="height:100%;width:100%" class="panel panel-default" >
     ...
     <tr style="height:100%;margin:10%">
         ...
         <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPlayed" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
     <tr style="height:100%;margin:10%">
         ...
         <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtWon" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
     <tr style="margin:10%">
         ...
         <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtLost" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
    <tr style="margin:10%">
        ...
        <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtTied" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
    <tr style="margin:10%">
        ...
        <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtNR" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
    <tr style="margin:10%">
        ...
        <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtNetRR" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
     <tr style="margin:10%">
         ...
         <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtPoints" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
    <tr style="margin:10%">
        ...
        <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtFromPoints" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                </td>
     </tr>
     <tr><td><br /></td></tr>
     <tr>
