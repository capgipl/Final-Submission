     ...
     <tr  style="height:100%;margin:10%">
         ...
         <td><asp:TextBox runat="server" class="col-xs-3" ID="txtMatchName" CssClass="form-control"></asp:TextBox></td>
          <td>
                    ...
                    <asp:RegularExpressionValidator ID="revName" runat="server" ControlToValidate="txtMatchName" ValidationExpression="^[A-Z]{1}[a-z\s]{1,}$" Text="MatchName starting with capital" ErrorMessage="[Name should start with capital]" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                </td>
     </tr>
     <tr style="height:100%;margin:10%">
