   ...
   <div style="height:100%;width:100%" class="panel panel-default" >
     ...
     <tr  style="height:100%;margin:10%">
         ...
         <td><asp:TextBox runat="server" class="col-xs-3" ID="txtteamid" CssClass="form-control" TextMode="Date"></asp:TextBox></td>
          <td>
                    <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtteamid" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
     ...
     <tr style="height:100%;margin:10%">
         ...
         <td><asp:TextBox runat="server" class="col-xs-3"  CssClass="form-control" ID="txtNewsDesc"></asp:TextBox></td>
          <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtNewsDesc" Text="Please provide the data" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtNewsDesc" ValidationExpression="^[A-Z]{1}[a-z\s]{1,}$" Text=" Start with capital" ErrorMessage="[Start with capital]" ForeColor="Red" Display="Dynamic"></asp:RegularExpressionValidator>
                </td>
     </tr>
     <tr><td><br /></td></tr>
     <tr>
